...
const config = {
  ...
  description:
    'This map displays all current AGU Bridge Program partner departments. Users can filter both the map and list of departments by a variety of characteristics explained in the map legend below the map. When filtering by more than one characteristic, users will see departments that match ANY of the chosen characteristics. Make sure to close the filter box once you have made your selections. ',
